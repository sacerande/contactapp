Evolent Project Exercise - Candidate - Sachin Erande.

Please Note:

1. Rest API for contact managment application is written using Web API and Consumed using ASP.Net MVC.
   Located in Project ContactApp under Solution.
   	
2. Database: In Memory collection is used for back end. (so when worker process recyles session, collection items removed form memory.)
     functional aspects working ok.
...
5. To run test cases, please set key contactApiBaseAddress in app.config of ContactApp.Tests Project. 
   ...
   For time being, not used actual database at back end and session managment.
